...
export class PageController {
    ...
    public async index(req: Request, res: Response): Promise<any> {
        ...
        try {
            ...
            const logo = {
                imageUrl: '/assets/images/connectfy/connectfy-logo.svg',
            }
            ...
            const header = ejs.render(headerHtml, { logo });

            
            const html = ejs.render(template, { header, news, footer, tags, banner, logo, highlightServices, lstPersonas, lstSecretaries, lstNews, lstAdresses });
